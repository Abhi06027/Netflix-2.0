...
<main className='flex justify-center mt-32 items-center flex-col flex-1 text-center px-10   '  >
...
<p className=' text-lg sm:text-lg md:text-xl lg:text-xl mt-3  text-white  brightness-200 leading-tight '  >Ready to watch? Enter your email to create or restart your membership.</p>
